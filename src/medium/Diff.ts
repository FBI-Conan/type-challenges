...
type Diff<O, O1> = {
	[Property in keyof O | keyof O1 as Property extends keyof O
		? Property extends keyof O1
			? never
			: Property
		: Property]: Property extends keyof O
		? O[Property]
		: Property extends keyof O1
		? O1[Property]
		: never;
...
type y = keyof Foo | keyof Bar;

type z = "gender" extends keyof Bar ? true : false;

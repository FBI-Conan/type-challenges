...
type ReplaceKeys<U, T, Y extends Record<any, any>> = U extends Record<
	string,
	any
>
	? {
			[Property in keyof U]: Property extends T
				? Property extends keyof Y
					? Y[Property]
					: never
				: U[Property];
	  }
...
type x = ReplaceKeys<Nodes, "name" | "flag", { name: number; flag: string }>;
